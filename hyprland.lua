...
local notifications = "uwsm app -- dunst"
...
-- Screen capture
hl.bind('Print', hl.dsp.exec_cmd('uwsm app -- grim -g "$(slurp)" - | swappy -f -'))
hl.bind('SUPER + Print', hl.dsp.exec_cmd('uwsm app -- grim -g "$(slurp -d)" - | wl-copy'))
